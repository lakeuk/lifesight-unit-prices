...
1. **Load Data:** Open the Dashboard HTML file and drag your CSV file into the designated drop zone, or click **Browse Files**.
...
1. **Load Data:** Open the Return Matrix HTML file; Select Browse Files for `lifesight_fundprices_triangle.csv` or drag in files for a manual drop.
